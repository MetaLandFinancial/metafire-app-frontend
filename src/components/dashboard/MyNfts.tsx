                                    ...
                                    <div
                                        ...
                                        <div className="card_description p-3">
                                            ...
                                            <div className="buttons flex justify-between">
                                                <button
                                                    className={"w-[166px] text-white py-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-[7px]"}>
                                                ...
                                                <button
                                                   ...
                                                   <span className='bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text font-semibold'>
