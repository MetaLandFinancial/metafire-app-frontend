...
const Navbar = () => {
  ...
  return (
    <header
      className={
        "bg-[#8E54E933] py-2 md:py-6 border-b-2 border-b-purple-600 absolute w-full z-10"
      }
    >
      <div className="main_container">
        <div className="nav_wrapper flex items-center">
          ...
          <button
            className={
              "text-base font-semibold text-white py-4 px-6 bg-gradient-to-r from-blue-500 to-purple-600 rounded-[6px]"
            }
          >
            Connect Wallet
          </button>
