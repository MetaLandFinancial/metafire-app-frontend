...
const Loans = () => {
    ...
    return (
        <section
            ...
            <div className={`main_container max-w-[1300px] ${repayModal && 'overflow-y-hidden -z-20'}`}>
                <div className="my_collection_wrapper">
                    <div className="section_title pb-10 flex items-center justify-between">
                        <h2 className={"text-3xl md:text-5xl font-medium text-white"}>
                            Total :
                            <span
                                className={"bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text ml-2"}>
                                2 Loans
                            </span>
                        </h2>
                        <button>
                                ...
                                <div
                                    ...
                                    <div className="card_left md:flex gap-4 md:gap-8">
                                        <div className="card_img md:flex-shrink-0">
                                            <img className={"md:flex-shrink-0"} src={loansDataItems.loanCarImg.src}
                                                 alt="card-img"/>
                                        </div>
                                        ...
                                        <div className="card_title_wrapper md:flex md:flex-col md:justify-between">
                                            <div className="card_section_title flex md:flex-col justify-between py-5">
                                                ...
                                                <span className={"text-[10px] md:text-2xl font-bold text-white"}>
                                                    {loansDataItems.loanNbr}
                                                </span>
                                            </div>

                                            <div className="repay_btn">
                                                <p className={"text-[10px] md:text-xl font-bold bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text flex items-center gap-2 pb-5"}>
                                                    <img src={EthIcon.src} alt="icon"/>
                                                    {loansDataItems.ethPoints} ETH
                                                </p>

                                                <button onClick={() => setRepayModal(!repayModal)}
                                                        className={"w-[166px] py-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-[7px] text-white"}>
                                                    Repay
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div className="card_right md:flex md:flex-col md:justify-between flex-grow">
                                        <div className="card_top md:flex">
                                            <div
                                                className="card_left w-full flex md:flex-col justify-between pb-5 md:pb-0">
                                                <h2 className={"text-[10px] md:text-base font-medium text-white pb-0 md:pb-3"}>
                                                    Balance
                                                </h2>
                                            ...
                                            <div
                                                className="card_middle w-full flex md:flex-col justify-between pb-5 md:pb-0">
                                                <h2 className={"text-[10px] md:text-base font-medium text-white pb-3"}>
                                                    Borrow rate
                                                </h2>
                                            ...
                                            <div
                                                className="card_right w-full flex items-center md:flex-col justify-between pb-5 md:pb-0">
                                                <h2 className={"text-[10px] md:text-base font-medium text-white pb-0 md:pb-3"}>
                                                    Loan status
                                                </h2>

                                                {
                                                    loansDataItems.loanActiveStatus === "Active" && (
                                                        <div
                                                            className={"text-[10px] md:text-sm font-medium bg-[#54e96c26] py-[5px] px-[13px] inline-flex items-center gap-4 rounded-[7px] text-[#54E96C]"}>
                                                            <div className={"w-2 h-2 rounded-full bg-[#54E96C]"}></div>
...

                                                {
                                                    loansDataItems.loanActiveStatus === "Inactive" && (
                                                        <div
                                                            className={"text-[10px] md:text-sm font-medium bg-[#ffffff36] py-[5px] px-[13px] inline-flex items-center gap-4 rounded-[7px] text-[#ffffff78]"}>
                                                            <div className={"w-2 h-2 rounded-full bg-[#ffffff78]"}></div>
                                                            {loansDataItems.loanActiveStatus}
                                                        </div>
                                                    )
                                                }

                                                {
                                                    loansDataItems.loanActiveStatus === "Paused" && (
                                                        <div
                                                            className={"text-[10px] md:text-sm font-medium bg-[#e6404052] py-[5px] px-[13px] inline-flex items-center gap-4 rounded-[7px] text-[#E64040]"}>
                                                            <div className={"w-2 h-2 rounded-full bg-[#E64040]"}></div>
                                                            {loansDataItems.loanActiveStatus}
                                                        </div>
                                                    )
                                                }
                                        ...
                                        <div className="card_bottom md:flex ">
                                            <div className="card_left w-full flex md:flex-col justify-between pb-5 md:pb-0">
                                                <h2 className={"text-[10px] md:text-base font-medium text-white pb-0 md:pb-3 flex items-center gap-2"}>
                    ...
                    <div
                        ...
                        <div className="modal_info flex gap-4">
                            ...
                            <div className="modal_info_right w-full">
                                <h2 className={"font-bold text-[10px] lg:text-[22px] flex justify-between pb-2"}>
                                    <span>
                                        MetaFire NFT
                                    </span>
                                    <span>
                                ...
                                <div className={"flex items-center justify-between w-full pb-2"}>
                                    <p className={"text-[10px] lg:text-xl font-bold bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text flex items-center gap-2"}>
                                        <img src={EthIcon.src} alt="icon"/>
                                        0.0025487 ETH
                                    </p>
                                ...
                                <div className="repay_info w-full border border-[#4776e65e] rounded-2xl">
                                    <p className={"flex justify-between border-b border-b-[#4776e65e] px-[13px] py-[10px]"}>
                                    <span className={"text-[10px] lg:text-base font-medium text-white"}>
                                        Floor Price
                                    </span>
                                        <span
                                            className={"text-[10px] lg:text-base font-bold bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text flex items-center gap-2"}>
                                        <img src={EthIcon.src} alt="icon"/>
                                        1.2 ETH
                                    </span>
                                    </p>
                        ...
                        <div className="modal_amount py-10">
                            <p className={"rounded-2xl border border-solid border-blue-400 bg-gray-900 shadow-inner p-5 w-full flex justify-between"}>
                               <span className={"text-[10px] lg:text-base font-medium text-white"}>
                                        Amount
                                    </span>
                                <span
                        ...
                        <label className={"text-[10px] lg:text-sm font-medium text-white flex pb-6"}>
                            <div className={"flex gap-2"}>

                                <input type="checkbox"/>
                                <p>
                                    yes I am ready to get my NFT and agree to MetaFire <Link href={"#"}
                                                                                             className={"bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text"}> terms
                                    and conditions </Link>
                                </p>
                            </div>
                        </label>
