          ...
          <div className="w-full relative z-10">
            ...
            <div className="mt-16 md:mt-12 lg:mt-14 xl:mt-20 grid justify-items-center md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3">
              <div className="financeCard flex flex-col items-center mb-16 md:mb-[18px]">
                <div className="mt-[-65px] md:mt-[-55px] lg:mt-[-60px] xl:mt-[-85px] flex items-center justify-center border border-[#bbcfff66] bg-gradient-to-r from-blue-500 to-purple-600 h-[75px] w-[75px] md:h-[65px] md:w-[65px] lg:h-[80px] xl:h-[106px] lg:w-[80px] xl:w-[106px] rounded-full">
                  <Image
                    src={f1}
                    alt="f1"
              ...
              <div className="financeCard flex flex-col items-center mb-0 md:mb-[18px]">
                <div className="mt-[-65px] md:mt-[-55px] lg:mt-[-60px] xl:mt-[-85px] flex items-center justify-center border border-[#bbcfff66] bg-gradient-to-r from-blue-500 to-purple-600 h-[75px] w-[75px] lg:h-[80px] xl:h-[106px] lg:w-[80px] xl:w-[106px] rounded-full">
                  <Image
                    src={f3}
                    alt="f3"
